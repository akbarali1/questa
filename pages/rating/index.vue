<template>
  <div class="container  card mt-4 mb-4">
    ...
    <div>
      <div class="d-flex bd-highlight">
        ...
        <div class="p-2 bd-highlight">
          <nuxt-link type="button" :to="localePath(`/rating/championship`)" class="btn btn-primary btn3d">{{ $t('championship_rating_short') }}</nuxt-link>
        </div>
      </div>
      <div class="card mt-1">
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2523122132362890"   crossorigin="anonymous"></script>
  </div>
</template>
...
export default {
  ...
  methods: {
    async getActiveChampionship() {
      const response = await this.$axios.get(`/championship/active`,
        {
          headers: {
