            ...
            <div class=" grid-container" :class="{'animate__animated animate__bounceInUp': animated}">
              <div class="grid-item">
                <nuxt-link :to="localePath('/auth/login')"
                           class="text-decoration-none" title="Login">
              ...
              <div class="grid-item">
                <div :class="[
                  ...
                  <span id="timer" style=" font-weight: 900; " class="timer-text"> {{ countDown }} {{ this.$t('second_2') }}</span>
                </div>
              </div>
              <div class="grid-item">
      ...
      <div class="container position-absolute top-50 start-50 translate-middle card card-body" v-if="complete === true">
        <div class="text-center">
          ...
          <nuxt-link :to="`/auth/login`">
            <span :class="[ $ua.isFromPc() !== true ? 'p-2 fs-6':'p-3 fs-3', 'btn btn-success col-md-2' ]">{{ this.$t('enterPage') }}</span>
          </nuxt-link>
        </div>
      </div>
    </main>
